...
export const REFRESH_EVENT = '[AUTHENTICATION] refresh';
export const REFRESH_EVENT_SUCCESS = '[AUTHENTICATION] refresh success';
export const REFRESH_EVENT_FAILURE = '[AUTHENTICATION] refresh failure';
